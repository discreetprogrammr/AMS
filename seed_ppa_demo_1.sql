...
--
-- NOTE: your live database's asset_status enum was widened past the
-- original schema.sql (schema_step15.sql renamed 'under_maintenance' to
-- 'attention' and added 'down'). Valid values are now: 'operational',
-- 'attention', 'down', 'unserviceable'. This script has been updated to
-- use 'attention' accordingly.
...
begin
  ...
  insert into assets (organization_id, site_id, asset_tag, equipment_type, brand, model, serial_number, sold_by, install_date, status, warranty_end_date, custodian, pnri_license_number, next_service_due)
  values (v_org_id, v_site_batangas, 'PPA-BAT-XRY-02', 'xray_screening', 'Smiths Detection', 'HI-SCAN 100100T-2is', 'SD-HS100T-40217', 'third_party', '2021-11-02', 'attention', '2024-11-02', 'Port Engineer, Batangas Port Management Office', 'PNRI-XRD-2021-0099', '2026-08-15')
